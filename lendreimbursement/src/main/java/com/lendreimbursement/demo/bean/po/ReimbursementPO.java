...
/**
 * @Author: [caiwenxian]
 * @Date: [2018-04-02 14:59]
 * @Description: [ ]
 * @Version: [1.0.0]
 */
@Entity
@Table(name = "lendreimbursement_reimbursement")
public class ReimbursementPO extends BasePO {
    ...
    @JoinColumn(name = "reimbursementAuditing")
    private List<ReimbursementAuditingPO> reimbursementAuditing;

    @OneToMany(cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "reimbursementMailing")
    private Set<ReimbursementMailingPO> reimbursementMailing;
    ...
    public boolean getNeedAnalysis() {
        return needAnalysis;
    }
    ...
    public List<ReimbursementAuditingPO> getReimbursementAuditing() {
        return reimbursementAuditing;
    }

    public void setReimbursementAuditing(List<ReimbursementAuditingPO> reimbursementAuditing) {
        this.reimbursementAuditing = reimbursementAuditing;
    }

    public Set<ReimbursementMailingPO> getReimbursementMailing() {
        return reimbursementMailing;
    }

    public void setReimbursementMailing(Set<ReimbursementMailingPO> reimbursementMailing) {
        this.reimbursementMailing = reimbursementMailing;
    }
